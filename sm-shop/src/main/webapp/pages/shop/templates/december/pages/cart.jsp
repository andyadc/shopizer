													...
													<td>
															...
															<div class="cart-del">
																	<a href="#" class="cart-close removeProductIcon"
																		...
																		onclick="updateUnavailableLineItem('${unavailable.id}','${removeShoppingCartItemUrl}'); return false;">
														...
														<tr>
															...
															<td width="10%" class="actions" data-th="">
																<div class="cart-del">
																	<a href="#" class="cart-close removeProductIcon"
																		style="clear: both !important;"
																		onclick="updateLineItem('${shoppingCartItem.id}','${removeShoppingCartItemUrl}'); return false;">
																		<i class="fa fa-times"></i>
																	</a> <input type="hidden" name="lineItemId" id="lineItemId"
