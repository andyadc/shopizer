...
public class ReadableProductTypeMapper implements Mapper<ProductType, ReadableProductType> {
	...
	private ReadableProductType type (ProductType type, Language language) {
		...
		readableType.setVisible(type.getVisible() != null && type.getVisible().booleanValue());
		readableType.setAllowAddToCart(type.getAllowAddToCart() != null && type.getAllowAddToCart().booleanValue());
